...
If you set up the workspace, manage the team, run campaigns, or configure settings, see the [Admin Guide](../admin/index.md) instead.
...
| [Notifications](notifications.md) | How you're alerted to assignments, mentions, and new messages — and how to manage it. |
...
!!! note "Auto-responders, campaigns, and settings"
    Automatic after-hours replies ([auto-responders](../admin/auto-responders.md)), outbound campaigns ([Broadcast](../broadcast/index.md)), and keyword automations ([Keywords](../keywords/index.md)) are configured by admins and managers — see the [Admin Guide](../admin/index.md).
