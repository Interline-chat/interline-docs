...
!!! note "Auto-responders vs. Keywords"
    Auto-responders reply to *any* incoming message based on the **time** it arrives. [Keywords](../keywords/index.md) reply based on the **specific word** a client texts in. Use auto-responders for office hours; use Keywords for things like “text HOURS for our opening times.”
